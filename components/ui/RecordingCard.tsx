    ...
    <Card className="group hover:shadow-md transition-all">
      ...
      <CardHeader className="space-y-1">
        <div className="space-y-2">
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center text-sm text-muted-foreground gap-2 not-dark:text-slate-900">
              <CalendarIcon className="h-3.5 w-3.5" />
              <span>{formattedStartTime}</span>
            </div>
            <div className="flex items-center text-sm text-muted-foreground gap-2 not-dark:text-blue-800">
      ...
      <CardContent>
        ...
        >
          <div className="size-12 rounded-full bg-background/90 flex items-center justify-center group-hover:bg-primary transition-colors">
            <PlayIcon className="size-6 text-muted-foreground group-hover:text-primary-foreground transition-colors not-dark:text-blue-400" />
          </div>
        </div>
      </CardContent>
      <CardFooter className="gap-2">
        ...
        <Button variant="secondary" onClick={handleCopyLink}>
          <CopyIcon className="size-4 dark:text-pink-900 not-dark:text-pink-600" />
        </Button>
      </CardFooter>
    </Card>
  );
